...
<div style="margin-top: 50px;text-align: center;">
    ...
    <div>
        <img src="${pageContext.request.contextPath}/image/success.jpg" style="width: 200px;height: 200px">
    </div>
    <br/>
    ...
    <div style="margin-right: 100px;float: left;margin-left: 645px;margin-top: 50px;">
        <a style="text-decoration: none" href="${pageContext.request.contextPath}/order/disOrderById.do?page=1">查看订单</a>
    </div>
...
<script type="text/javascript">
    ...
    function UpdatePay() {
        alert("支付成功，准备跳转到主页");
        location.href="${pageContext.request.contextPath}/order/updatePayState.do?paystate=1";
    }
</script>
</body>
</html>
