...
<div style="width: 200px;height:673px;border:double;text-align: center;float: left;">
    <div style="margin-top: 30px;margin-right: 20px;font-weight: bold;font-size: 18px;"><a href="${pageContext.request.contextPath}/user/disUser.do?page=1&username=">用户管理</a></div>
...
<div style="width: 1293px;height:673px;border:double;float: left;">
    ...
    <form style="border-bottom: 50px;" id="Form" action="${pageContext.request.contextPath}/DeleteUserServlet?page=1" method="post" >
        <table style="display: inline-block;text-align: center; margin: 10px" >
            ...
            <c:forEach items="${all.list}" var="user" varStatus="u">
                <tr>
                    ...
                    <td style="height: 55px;border: 1px dashed;">${user.address}</td>
                </tr>
            </c:forEach>
            <tr>
                <td style="height: 50px;">
                    <input type="submit" name="delete" id="delete" value="delete" onclick="deletex()">
                </td>
                <td style="height: 50px;">
